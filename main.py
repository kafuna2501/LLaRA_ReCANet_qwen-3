...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default='/content/drive/MyDrive/Uozumi/data/ref/retail_2', type=str)
    ...
    parser.add_argument('--llm_path', default='Qwen/Qwen3-4B-Instruct-2507', type=str)
    ...
    parser.add_argument('--rec_embed', default="SASRec", choices=['SASRec', 'Caser','GRU', 'ReCANet'], type=str)
    ...
    parser.add_argument('--lora_target_modules', default=None, type=str)
